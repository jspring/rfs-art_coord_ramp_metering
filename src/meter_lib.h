...
extern int get_phase3_signal_status(void);
extern int get_phase6_signal_status(void);
extern int get_phase7_signal_status(void);
extern int get_phase8_signal_status(void);
extern int get_phase5_signal_status(void);
extern int get_phase5_approach1_status();
extern int get_phase5_approach2_status();
extern int get_phase5_stopbar_status();
extern int get_phase8_approach_status();
extern int get_phase8_stopbar_status();

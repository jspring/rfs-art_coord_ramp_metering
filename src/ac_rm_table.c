...
//get_long_status8_resp_mess_typ
        ...
        {"%.3f ",   &urms_datafile.mainline_lead_occ[0], BASE_FLOAT, REPLAY_USE},	//###20
        ...
        {"%.3f ",   &urms_datafile.mainline_trail_occ[0], BASE_FLOAT, REPLAY_USE},	//###23
        ...
        {"%.3f ",   &urms_datafile.mainline_lead_occ[1], BASE_FLOAT, REPLAY_USE},	//###26
        ...
        {"%.3f ",   &urms_datafile.mainline_trail_occ[1], BASE_FLOAT, REPLAY_USE},	//###29
        ...
        {"%.3f ",   &urms_datafile.mainline_lead_occ[2], BASE_FLOAT, REPLAY_USE},	//###33
        {"%hhu ",   &db_urms_status.mainline_stat[2].trail_vol, BASE_CHAR, REPLAY_USE},	//###34
        {"%.3f ",   &urms_datafile.mainline_trail_occ[2], BASE_FLOAT, REPLAY_USE},	//###35
        ...
        {"%.3f ",   &urms_datafile.queue_occ[0], BASE_FLOAT, REPLAY_USE},	//###38
        ...
        {"%.3f ",   &urms_datafile.queue_occ[1], BASE_FLOAT, REPLAY_USE},	//###46
        ...
        {"%.3f ",   &urms_datafile.queue_occ[2], BASE_FLOAT, REPLAY_USE},	//###54
	...
	{"%.3f ",   &db_signal_data.LT_occ, BASE_FLOAT, REPLAY_USE}, 		//###70
	{"%.3f ",   &db_signal_data.old_LT_occ, BASE_FLOAT, REPLAY_USE}, 	//###71
	{"%.3f ",   &db_signal_data.RT_occ, BASE_FLOAT, REPLAY_USE}, 		//###72
	...
	{"%hhu ",   &db_urms_status.hour, BASE_CHAR, REPLAY_USE},			//###103
};
